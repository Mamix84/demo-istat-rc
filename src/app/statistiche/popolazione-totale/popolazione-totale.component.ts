...
@Component({
  selector: 'app-popolazione-totale',
  templateUrl: './popolazione-totale.component.html',
  styleUrls: ['./popolazione-totale.component.scss'],
  providers: [MessageService],
})
export class PopolazioneTotaleComponent implements OnInit {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    for (let i = 0; i < this.comune.dati.length; i++) {
      if (this.comune.dati[i].tipo === 'MF' && this.comune.dati[i].anno > 1982) {
